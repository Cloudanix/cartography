...
CREATE INDEX IF NOT EXISTS FOR (n:AWSSagemakerNotebookInstance) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:AWSSagemakerEndpoint) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:AWSSagemakerTrainingJob) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:AWSSagemakerModel) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:AWSSagemakerDomain) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:AWSSagemakerCluster) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:AWSBedrockAgent) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:AWSBedrockCustomModel) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:AWSBedrockGuardRail) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:AWSBedrockCustomisationJob) ON (n.arn);
...
CREATE INDEX IF NOT EXISTS FOR (n:OCIContainerRepository) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCIContainerImage) ON (n.id);
...
CREATE INDEX IF NOT EXISTS FOR (n:OCITag) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:OCITag) ON (n.key);
...
CREATE INDEX IF NOT EXISTS FOR (n:OCIAutonomousDatabase) ON (n.id);
